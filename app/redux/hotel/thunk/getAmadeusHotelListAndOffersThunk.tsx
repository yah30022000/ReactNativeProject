...
import { HotelOffersRequest } from "../../../helper/amadeus/hotel-offers-request-response";

export interface HotelListAndOffersRequest extends HotelListRequest, Omit<HotelOffersRequest, 'hotelIds'> {
  hotelIds?: Array<string>
}

export const getAmadeusHotelListAndOffersThunk = createAsyncThunk<any, HotelListAndOffersRequest>(
  ...
  async (queryParams: HotelListAndOffersRequest, thunkAPI) => {
    ...
    let response: any = await AmplifyAPI.get(apiName, path, option);
