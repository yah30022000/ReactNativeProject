...
} from "../screens/hotels/hotel-search-screen";
import {
  HotelListScreen,
  HotelSearchListProps,
} from "../screens/hotels/hotel-list-screen";
import {
  HotelDetailScreen,
  HotelDetailScreenProps,
} from "../screens/hotels/hotel-detail-screen";
import {
  HotelRoomSelectScreen,
  HotelRoomSelectScreenProps,
} from "../screens/hotels/hotel-room-select-screen";
import {
  PaymentScreen,
  PaymentScreenProps,
} from "../screens/payment/payment-screen";
import {
  PaymentCompleteScreen,
  PaymentCompleteScreenProps,
} from "../screens/payment/payment-complete-screen";
